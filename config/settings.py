...
DATABASES = {
    "default": {
        ...
        "NAME": env_str("POSTGRES_DB", "boilerworks"),
...
if USE_S3:
    ...
    AWS_STORAGE_BUCKET_NAME = env_str("AWS_STORAGE_BUCKET_NAME", "boilerworks")
...
DEFAULT_FROM_EMAIL = env_str("FROM_EMAIL", "no-reply@boilerworks.local")
...
CONSTANCE_CONFIG = {
    "SITE_NAME": ("Boilerworks", "Display name for the site"),
}
...
ADMIN_SITE_HEADER = "Boilerworks"
ADMIN_SITE_TITLE = f"Boilerworks Admin {VERSION}"
