...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        admin_user, created = User.objects.get_or_create(
            username="admin",
            defaults={"email": "admin@boilerworks.local", "is_staff": True, "is_superuser": True},
        )
        if created:
        ...
        viewer_user, created = User.objects.get_or_create(
            username="viewer",
            defaults={"email": "viewer@boilerworks.local", "is_staff": False, "is_superuser": False},
        )
        if created:
        ...
        # Organization
        org, _ = Organization.objects.get_or_create(name="Boilerworks HQ", defaults={"description": "Default organization"})
